<script>
   ...
   * of what to do next: more of the same, a swing, or a rating of what is here. Gone while a
   * follow-up runs, whichever control started it: the divider above says what is happening.
   */
...
<div class="results-more">
  <AgentOrb class="results-more-orb" state="idle" />
